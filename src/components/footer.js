...
const Footer = () => {
  const social = [
    { name: "Instagram", href: "https://www.instagram.com/hannnkusa/" },
    { name: "GitHub", href: "https://github.com/hannnkusa" },
    { name: "GitLab", href: "https://gitlab.com/hankusa1709" },
  ];
  return (
